...
public class SeekArc extends View
{
    ...
    private void init(Context context, AttributeSet attrs, int defStyle)
    {
        ...
        if (attrs != null)
        {
            ...
            arcColor = a.getColor(R.styleable.SeekArc_arcColor, Color.RED);
	 ...
	 * onStartTrackingTouch(); updateOnTouch(event); break; case
	 * MotionEvent.ACTION_MOVE: updateOnTouch(event); break; case
	 * MotionEvent.ACTION_UP: onStopTrackingTouch(); setPressed(false); break;
	 * case MotionEvent.ACTION_CANCEL: onStopTrackingTouch(); setPressed(false);
	 *
	 * break; }
	 *
	 * return true; }
