package com.example.idea.myapplication.view;
...
public class MyVideoView extends SurfaceView implements MediaPlayerControl {
    ...
    /**
     * add by yangguangfu 自定义监听器，用于监听屏蔽大小是否改变
     */
     ...
     * add by yangguangfu 自定义监听器，用于监听屏蔽大小是否改变
     */
    interface SizeChangeLinstener {
        void doMyThings();
    }

    /**
     * add by yangguangfu 自定义监听器，用于监听屏蔽大小是否改变,用于提供给其他类调用。
     */
    public void setSizeChangeLinstener(SizeChangeLinstener l) {
